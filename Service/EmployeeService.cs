...
namespace Service
{
    internal sealed class EmployeeService: IEmployeeService
    {
        ...
        public async Task DeleteEmployeeForCompanyAsync(Guid companyId, Guid id, bool trackChanges)
        {
            ...
            _repository.Employee.DeleteEmployeeAsync(employeeForCompany);
            await _repository.SaveAsync();
        }
        ...
        public async Task<(EmployeeForUpdateDto employeeToPatch, Employee employeeEntity)> GetEmployeeForPatchAsync(Guid companyId, Guid id, bool compTrackChanges, bool empTrackChanges)
        {
            ...
            var employeeFromDb = await GetemployeeForCompanyAndCheckIfItExists(companyId, id, empTrackChanges);

            var employeeToPach = _mapper.Map<EmployeeForUpdateDto>(employeeFromDb);

            return (employeeToPach, employeeFromDb);
        }
        ...
        public async Task SaveChangesForPatchAsync(EmployeeForUpdateDto employeeToPach, Employee employeeEntity)
        {
            _mapper.Map(employeeToPach, employeeEntity);
            await _repository.SaveAsync();
        }
        ...
        public async Task UpdateEmployeeForCompanyAsync(Guid companyId, Guid id, EmployeeForUpdateDto employeeForUpdate, bool compTrackChanges, bool empTrackChanges)
        {
            ...
            _mapper.Map(employeeForUpdate, employeeFromDb);
            await _repository.SaveAsync();
        }
