...
namespace Service
{
    internal sealed class CompanyService: ICompanyService
    {
        ...
        public async Task<CompanyDto> CreateCompanyAsync(CompanyForCreationDto company)
        {
            ...
            _repository.Company.CreateCompanyAsync(companyEntity);
        ...
        public async Task<(IEnumerable<CompanyDto> companies, string ids)> CreateCompanyCollectionAsync(IEnumerable<CompanyForCreationDto> companyCollection)
        {
            ...
            {
                _repository.Company.CreateCompanyAsync(company);
            }
        ...
        public async Task DeleteCompanyAsync(Guid companyId, bool trackChanges)
        {
            ...
            _repository.Company.DeleteCompanyAsync(companyEntity);
            await _repository.SaveAsync();
        ...
        {
            var companyEntities = await _repository.Company.GetAllCompaniesAsync(trackChanges);
